...
public class Deletegermplasmpropertybyname extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1128421465;

    /**
     * The parameter <code>public.deletegermplasmpropertybyname.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.deletegermplasmpropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.deletegermplasmpropertybyname.propertyname</code>.
     */
     ...
     */
    public Deletegermplasmpropertybyname() {
        super("deletegermplasmpropertybyname", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
