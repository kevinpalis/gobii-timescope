...
public class CitextNe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1648994699;

    /**
     * The parameter <code>public.citext_ne.RETURN_VALUE</code>.
     */
     ...
     */
    public CitextNe() {
        super("citext_ne", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
