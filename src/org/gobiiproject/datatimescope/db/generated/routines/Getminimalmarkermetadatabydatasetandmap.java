...
public class Getminimalmarkermetadatabydatasetandmap extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -632664001;

    /**
     * The parameter <code>public.getminimalmarkermetadatabydatasetandmap.datasetid</code>.
     */
    public static final Parameter<Integer> DATASETID = createParameter("datasetid", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getminimalmarkermetadatabydatasetandmap.mapid</code>.
     */
    public static final Parameter<Integer> MAPID = createParameter("mapid", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getminimalmarkermetadatabydatasetandmap.marker_name</code>.
     */
    public static final Parameter<String> MARKER_NAME = createParameter("marker_name", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>public.getminimalmarkermetadatabydatasetandmap.alleles</code>.
     */
    public static final Parameter<String> ALLELES = createParameter("alleles", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>public.getminimalmarkermetadatabydatasetandmap.chrom</code>.
     */
    public static final Parameter<String> CHROM = createParameter("chrom", org.jooq.impl.SQLDataType.VARCHAR, false, false);

    /**
     * The parameter <code>public.getminimalmarkermetadatabydatasetandmap.pos</code>.
     */
    public static final Parameter<BigDecimal> POS = createParameter("pos", org.jooq.impl.SQLDataType.NUMERIC, false, false);

    /**
     * The parameter <code>public.getminimalmarkermetadatabydatasetandmap.strand</code>.
     */
    ...
    public Getminimalmarkermetadatabydatasetandmap() {
        super("getminimalmarkermetadatabydatasetandmap", Public.PUBLIC);
