...
public class Getplatformpropertybyname extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1846303161;

    /**
     * The parameter <code>public.getplatformpropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getplatformpropertybyname.propertyname</code>.
     */
    ...
    /**
     * The parameter <code>public.getplatformpropertybyname.property_id</code>.
     */
    ...
    /**
     * The parameter <code>public.getplatformpropertybyname.property_value</code>.
     */
    ...
    public Getplatformpropertybyname() {
        super("getplatformpropertybyname", Public.PUBLIC);
