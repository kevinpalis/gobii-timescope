...
public class Updateprojectpropertybyid extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1809539504;

    /**
     * The parameter <code>public.updateprojectpropertybyid.projectid</code>.
     */
    public static final Parameter<Integer> PROJECTID = createParameter("projectid", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.updateprojectpropertybyid.propertyid</code>.
     */
    ...
    /**
     * The parameter <code>public.updateprojectpropertybyid.propertyvalue</code>.
     */
     ...
     */
    public Updateprojectpropertybyid() {
        super("updateprojectpropertybyid", Public.PUBLIC);
