...
public class CitextGe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -958354567;

    /**
     * The parameter <code>public.citext_ge.RETURN_VALUE</code>.
     */
     ...
     */
    public CitextGe() {
        super("citext_ge", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
