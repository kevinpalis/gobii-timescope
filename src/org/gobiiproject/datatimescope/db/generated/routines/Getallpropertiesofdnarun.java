...
public class Getallpropertiesofdnarun extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1049804520;

    /**
     * The parameter <code>public.getallpropertiesofdnarun.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getallpropertiesofdnarun.property_id</code>.
     */
    ...
    /**
     * The parameter <code>public.getallpropertiesofdnarun.property_name</code>.
     */
    ...
    /**
     * The parameter <code>public.getallpropertiesofdnarun.property_value</code>.
     */
    ...
    public Getallpropertiesofdnarun() {
        super("getallpropertiesofdnarun", Public.PUBLIC);
