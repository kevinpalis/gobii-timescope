...
public class RegexpMatches2 extends AbstractRoutine<String[]> {
    ...
    private static final long serialVersionUID = 1312501088;

    /**
     * The parameter <code>public.regexp_matches.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.regexp_matches._3</code>.
     */
    ...
    public RegexpMatches2() {
        super("regexp_matches", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB.getArrayDataType());
