...
public class Deletemapsetpropertybyname extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1057126935;

    /**
     * The parameter <code>public.deletemapsetpropertybyname.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.deletemapsetpropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.deletemapsetpropertybyname.propertyname</code>.
     */
     ...
     */
    public Deletemapsetpropertybyname() {
        super("deletemapsetpropertybyname", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
