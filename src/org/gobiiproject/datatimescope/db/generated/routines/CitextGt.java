...
public class CitextGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1280294455;

    /**
     * The parameter <code>public.citext_gt.RETURN_VALUE</code>.
     */
     ...
     */
    public CitextGt() {
        super("citext_gt", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
