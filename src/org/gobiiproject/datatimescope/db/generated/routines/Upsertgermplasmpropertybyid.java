...
public class Upsertgermplasmpropertybyid extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -954542655;

    /**
     * The parameter <code>public.upsertgermplasmpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.upsertgermplasmpropertybyid.propertyid</code>.
     */
    ...
    /**
     * The parameter <code>public.upsertgermplasmpropertybyid.propertyvalue</code>.
     */
     ...
     */
    public Upsertgermplasmpropertybyid() {
        super("upsertgermplasmpropertybyid", Public.PUBLIC);
