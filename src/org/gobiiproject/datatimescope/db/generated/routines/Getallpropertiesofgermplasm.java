...
public class Getallpropertiesofgermplasm extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1701162920;

    /**
     * The parameter <code>public.getallpropertiesofgermplasm.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getallpropertiesofgermplasm.property_id</code>.
     */
    ...
    /**
     * The parameter <code>public.getallpropertiesofgermplasm.property_name</code>.
     */
    ...
    /**
     * The parameter <code>public.getallpropertiesofgermplasm.property_value</code>.
     */
    ...
    public Getallpropertiesofgermplasm() {
        super("getallpropertiesofgermplasm", Public.PUBLIC);
