...
public class Upsertprojectpropertybyid extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1212021415;

    /**
     * The parameter <code>public.upsertprojectpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.upsertprojectpropertybyid.propertyid</code>.
     */
    ...
    /**
     * The parameter <code>public.upsertprojectpropertybyid.propertyvalue</code>.
     */
     ...
     */
    public Upsertprojectpropertybyid() {
        super("upsertprojectpropertybyid", Public.PUBLIC);
