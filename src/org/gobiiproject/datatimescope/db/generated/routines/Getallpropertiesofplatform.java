...
public class Getallpropertiesofplatform extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 2117677813;

    /**
     * The parameter <code>public.getallpropertiesofplatform.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getallpropertiesofplatform.property_id</code>.
     */
    ...
    /**
     * The parameter <code>public.getallpropertiesofplatform.property_name</code>.
     */
    ...
    /**
     * The parameter <code>public.getallpropertiesofplatform.property_value</code>.
     */
    ...
    public Getallpropertiesofplatform() {
        super("getallpropertiesofplatform", Public.PUBLIC);
