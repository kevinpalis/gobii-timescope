...
public class Updatemapsetpropertybyid extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -670626547;

    /**
     * The parameter <code>public.updatemapsetpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.updatemapsetpropertybyid.propertyid</code>.
     */
    ...
    /**
     * The parameter <code>public.updatemapsetpropertybyid.propertyvalue</code>.
     */
     ...
     */
    public Updatemapsetpropertybyid() {
        super("updatemapsetpropertybyid", Public.PUBLIC);
