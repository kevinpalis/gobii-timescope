...
public class Getminimalsamplemetadatabydataset extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 2094815073;

    /**
     * The parameter <code>public.getminimalsamplemetadatabydataset.datasetid</code>.
     */
    public static final Parameter<Integer> DATASETID = createParameter("datasetid", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getminimalsamplemetadatabydataset.dnarun_name</code>.
     */
    public static final Parameter<String> DNARUN_NAME = createParameter("dnarun_name", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>public.getminimalsamplemetadatabydataset.sample_name</code>.
     */
    public static final Parameter<String> SAMPLE_NAME = createParameter("sample_name", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>public.getminimalsamplemetadatabydataset.germplasm_name</code>.
     */
    ...
    /**
     * The parameter <code>public.getminimalsamplemetadatabydataset.external_code</code>.
     */
    ...
    /**
     * The parameter <code>public.getminimalsamplemetadatabydataset.germplasm_type</code>.
     */
    ...
    public Getminimalsamplemetadatabydataset() {
        super("getminimalsamplemetadatabydataset", Public.PUBLIC);
