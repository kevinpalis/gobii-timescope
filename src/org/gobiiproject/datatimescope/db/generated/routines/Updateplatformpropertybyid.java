...
public class Updateplatformpropertybyid extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1776420525;

    /**
     * The parameter <code>public.updateplatformpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.updateplatformpropertybyid.propertyid</code>.
     */
    ...
    /**
     * The parameter <code>public.updateplatformpropertybyid.propertyvalue</code>.
     */
     ...
     */
    public Updateplatformpropertybyid() {
        super("updateplatformpropertybyid", Public.PUBLIC);
