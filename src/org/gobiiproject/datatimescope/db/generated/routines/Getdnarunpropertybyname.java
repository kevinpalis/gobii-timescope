...
public class Getdnarunpropertybyname extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -122751194;

    /**
     * The parameter <code>public.getdnarunpropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getdnarunpropertybyname.propertyname</code>.
     */
    ...
    /**
     * The parameter <code>public.getdnarunpropertybyname.property_id</code>.
     */
    ...
    /**
     * The parameter <code>public.getdnarunpropertybyname.property_value</code>.
     */
    ...
    public Getdnarunpropertybyname() {
        super("getdnarunpropertybyname", Public.PUBLIC);
