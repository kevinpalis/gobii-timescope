...
public class Appendroletocontact extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 933541841;

    /**
     * The parameter <code>public.appendroletocontact.contactid</code>.
     */
    public static final Parameter<Integer> CONTACTID = createParameter("contactid", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.appendroletocontact.roleid</code>.
     */
     ...
     */
    public Appendroletocontact() {
        super("appendroletocontact", Public.PUBLIC);
