...
public class Appendwritetabletorole extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1476759730;

    /**
     * The parameter <code>public.appendwritetabletorole.roleid</code>.
     */
    public static final Parameter<Integer> ROLEID = createParameter("roleid", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.appendwritetabletorole.tableid</code>.
     */
     ...
     */
    public Appendwritetabletorole() {
        super("appendwritetabletorole", Public.PUBLIC);
