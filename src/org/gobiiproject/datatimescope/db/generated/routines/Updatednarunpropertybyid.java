...
public class Updatednarunpropertybyid extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -131059635;

    /**
     * The parameter <code>public.updatednarunpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.updatednarunpropertybyid.propertyid</code>.
     */
    ...
    /**
     * The parameter <code>public.updatednarunpropertybyid.propertyvalue</code>.
     */
     ...
     */
    public Updatednarunpropertybyid() {
        super("updatednarunpropertybyid", Public.PUBLIC);
