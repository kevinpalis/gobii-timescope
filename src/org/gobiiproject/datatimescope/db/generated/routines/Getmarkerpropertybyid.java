...
public class Getmarkerpropertybyid extends AbstractRoutine<String> {

    private static final long serialVersionUID = -404087800;

    /**
     * The parameter <code>public.getmarkerpropertybyid.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.getmarkerpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getmarkerpropertybyid.propertyid</code>.
     */
     ...
     */
    public Getmarkerpropertybyid() {
        super("getmarkerpropertybyid", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
