...
public class CitextCmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -906353309;

    /**
     * The parameter <code>public.citext_cmp.RETURN_VALUE</code>.
     */
     ...
     */
    public CitextCmp() {
        super("citext_cmp", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
