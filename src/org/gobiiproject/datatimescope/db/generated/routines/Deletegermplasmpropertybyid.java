...
public class Deletegermplasmpropertybyid extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -429979104;

    /**
     * The parameter <code>public.deletegermplasmpropertybyid.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.deletegermplasmpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.deletegermplasmpropertybyid.propertyid</code>.
     */
     ...
     */
    public Deletegermplasmpropertybyid() {
        super("deletegermplasmpropertybyid", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
