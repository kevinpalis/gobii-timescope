...
public class Getmarkerallmapsetinfobydataset extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 5645236;

    /**
     * The parameter <code>public.getmarkerallmapsetinfobydataset.dsid</code>.
     */
    public static final Parameter<Integer> DSID = createParameter("dsid", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getmarkerallmapsetinfobydataset.mapid</code>.
     */
    public static final Parameter<Integer> MAPID = createParameter("mapid", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getmarkerallmapsetinfobydataset.marker_name</code>.
     */
    public static final Parameter<String> MARKER_NAME = createParameter("marker_name", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>public.getmarkerallmapsetinfobydataset.platform_name</code>.
     */
    ...
    /**
     * The parameter <code>public.getmarkerallmapsetinfobydataset.linkage_group_start</code>.
     */
    ...
    /**
     * The parameter <code>public.getmarkerallmapsetinfobydataset.linkage_group_stop</code>.
     */
    ...
    /**
     * The parameter <code>public.getmarkerallmapsetinfobydataset.marker_linkage_group_start</code>.
     */
    ...
    /**
     * The parameter <code>public.getmarkerallmapsetinfobydataset.marker_linkage_group_stop</code>.
     */
    ...
    /**
     * The parameter <code>public.getmarkerallmapsetinfobydataset.reference_name</code>.
     */
    ...
    /**
     * The parameter <code>public.getmarkerallmapsetinfobydataset.reference_version</code>.
     */
    ...
    public Getmarkerallmapsetinfobydataset() {
        super("getmarkerallmapsetinfobydataset", Public.PUBLIC);
