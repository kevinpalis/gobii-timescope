...
public class Deletemarkerpropertybyid extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1737255794;

    /**
     * The parameter <code>public.deletemarkerpropertybyid.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.deletemarkerpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.deletemarkerpropertybyid.propertyid</code>.
     */
     ...
     */
    public Deletemarkerpropertybyid() {
        super("deletemarkerpropertybyid", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
