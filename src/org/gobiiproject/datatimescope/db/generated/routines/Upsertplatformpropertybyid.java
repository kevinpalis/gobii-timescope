...
public class Upsertplatformpropertybyid extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1202186349;

    /**
     * The parameter <code>public.upsertplatformpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.upsertplatformpropertybyid.propertyid</code>.
     */
    ...
    /**
     * The parameter <code>public.upsertplatformpropertybyid.propertyvalue</code>.
     */
     ...
     */
    public Upsertplatformpropertybyid() {
        super("upsertplatformpropertybyid", Public.PUBLIC);
