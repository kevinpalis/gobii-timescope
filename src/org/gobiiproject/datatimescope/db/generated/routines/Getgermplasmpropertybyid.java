...
public class Getgermplasmpropertybyid extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1703387306;

    /**
     * The parameter <code>public.getgermplasmpropertybyid.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.getgermplasmpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getgermplasmpropertybyid.propertyid</code>.
     */
     ...
     */
    public Getgermplasmpropertybyid() {
        super("getgermplasmpropertybyid", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
