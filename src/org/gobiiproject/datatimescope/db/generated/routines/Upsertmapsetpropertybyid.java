...
public class Upsertmapsetpropertybyid extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -450016947;

    /**
     * The parameter <code>public.upsertmapsetpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.upsertmapsetpropertybyid.propertyid</code>.
     */
    ...
    /**
     * The parameter <code>public.upsertmapsetpropertybyid.propertyvalue</code>.
     */
     ...
     */
    public Upsertmapsetpropertybyid() {
        super("upsertmapsetpropertybyid", Public.PUBLIC);
