...
public class Getgermplasmpropertybyname extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1837608974;

    /**
     * The parameter <code>public.getgermplasmpropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getgermplasmpropertybyname.propertyname</code>.
     */
    ...
    /**
     * The parameter <code>public.getgermplasmpropertybyname.property_id</code>.
     */
    ...
    /**
     * The parameter <code>public.getgermplasmpropertybyname.property_value</code>.
     */
    ...
    public Getgermplasmpropertybyname() {
        super("getgermplasmpropertybyname", Public.PUBLIC);
