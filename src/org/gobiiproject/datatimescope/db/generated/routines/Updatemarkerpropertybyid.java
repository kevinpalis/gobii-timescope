...
public class Updatemarkerpropertybyid extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 997065869;

    /**
     * The parameter <code>public.updatemarkerpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.updatemarkerpropertybyid.propertyid</code>.
     */
    ...
    /**
     * The parameter <code>public.updatemarkerpropertybyid.propertyvalue</code>.
     */
     ...
     */
    public Updatemarkerpropertybyid() {
        super("updatemarkerpropertybyid", Public.PUBLIC);
