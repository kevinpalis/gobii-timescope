...
public class Getmapsetpropertybyname extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -310641740;

    /**
     * The parameter <code>public.getmapsetpropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getmapsetpropertybyname.propertyname</code>.
     */
    ...
    /**
     * The parameter <code>public.getmapsetpropertybyname.property_id</code>.
     */
    ...
    /**
     * The parameter <code>public.getmapsetpropertybyname.property_value</code>.
     */
    ...
    public Getmapsetpropertybyname() {
        super("getmapsetpropertybyname", Public.PUBLIC);
