...
public class Updateplatformpropertybyname extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 510888195;

    /**
     * The parameter <code>public.updateplatformpropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.updateplatformpropertybyname.propertyname</code>.
     */
    ...
    /**
     * The parameter <code>public.updateplatformpropertybyname.propertyvalue</code>.
     */
     ...
     */
    public Updateplatformpropertybyname() {
        super("updateplatformpropertybyname", Public.PUBLIC);
