...
public class Getdnasamplepropertybyname extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -2121916039;

    /**
     * The parameter <code>public.getdnasamplepropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getdnasamplepropertybyname.propertyname</code>.
     */
    ...
    /**
     * The parameter <code>public.getdnasamplepropertybyname.property_id</code>.
     */
    ...
    /**
     * The parameter <code>public.getdnasamplepropertybyname.property_value</code>.
     */
    ...
    public Getdnasamplepropertybyname() {
        super("getdnasamplepropertybyname", Public.PUBLIC);
