...
public class Getmarkernamesbydataset extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1567231083;

    /**
     * The parameter <code>public.getmarkernamesbydataset.datasetid</code>.
     */
    public static final Parameter<Integer> DATASETID = createParameter("datasetid", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getmarkernamesbydataset.marker_id</code>.
     */
    public static final Parameter<Integer> MARKER_ID = createParameter("marker_id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getmarkernamesbydataset.marker_name</code>.
     */
    ...
    public Getmarkernamesbydataset() {
        super("getmarkernamesbydataset", Public.PUBLIC);
