...
public class Removereadtablefromrole extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1820877032;

    /**
     * The parameter <code>public.removereadtablefromrole.roleid</code>.
     */
    public static final Parameter<Integer> ROLEID = createParameter("roleid", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.removereadtablefromrole.tableid</code>.
     */
     ...
     */
    public Removereadtablefromrole() {
        super("removereadtablefromrole", Public.PUBLIC);
