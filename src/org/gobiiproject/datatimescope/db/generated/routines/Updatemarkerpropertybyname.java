...
public class Updatemarkerpropertybyname extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1472398749;

    /**
     * The parameter <code>public.updatemarkerpropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.updatemarkerpropertybyname.propertyname</code>.
     */
    ...
    /**
     * The parameter <code>public.updatemarkerpropertybyname.propertyvalue</code>.
     */
     ...
     */
    public Updatemarkerpropertybyname() {
        super("updatemarkerpropertybyname", Public.PUBLIC);
