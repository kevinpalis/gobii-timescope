...
public class CitextLe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2131171279;

    /**
     * The parameter <code>public.citext_le.RETURN_VALUE</code>.
     */
     ...
     */
    public CitextLe() {
        super("citext_le", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
