...
public class CitextEq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1262239147;

    /**
     * The parameter <code>public.citext_eq.RETURN_VALUE</code>.
     */
     ...
     */
    public CitextEq() {
        super("citext_eq", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
