...
public class Deletednarunpropertybyid extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 177624254;

    /**
     * The parameter <code>public.deletednarunpropertybyid.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.deletednarunpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.deletednarunpropertybyid.propertyid</code>.
     */
     ...
     */
    public Deletednarunpropertybyid() {
        super("deletednarunpropertybyid", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
