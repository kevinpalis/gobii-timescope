...
public class Getmarkerpropertybyname extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1448761600;

    /**
     * The parameter <code>public.getmarkerpropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getmarkerpropertybyname.propertyname</code>.
     */
    ...
    /**
     * The parameter <code>public.getmarkerpropertybyname.property_id</code>.
     */
    ...
    /**
     * The parameter <code>public.getmarkerpropertybyname.property_value</code>.
     */
    ...
    public Getmarkerpropertybyname() {
        super("getmarkerpropertybyname", Public.PUBLIC);
