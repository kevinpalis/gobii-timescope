...
public class Updategermplasmpropertybyname extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -966608299;

    /**
     * The parameter <code>public.updategermplasmpropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.updategermplasmpropertybyname.propertyname</code>.
     */
    ...
    /**
     * The parameter <code>public.updategermplasmpropertybyname.propertyvalue</code>.
     */
     ...
     */
    public Updategermplasmpropertybyname() {
        super("updategermplasmpropertybyname", Public.PUBLIC);
