...
public class Upsertdnasamplepropertybyid extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 26577847;

    /**
     * The parameter <code>public.upsertdnasamplepropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.upsertdnasamplepropertybyid.propertyid</code>.
     */
    ...
    /**
     * The parameter <code>public.upsertdnasamplepropertybyid.propertyvalue</code>.
     */
     ...
     */
    public Upsertdnasamplepropertybyid() {
        super("upsertdnasamplepropertybyid", Public.PUBLIC);
