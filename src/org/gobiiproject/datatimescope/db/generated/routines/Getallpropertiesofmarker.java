...
public class Getallpropertiesofmarker extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1305238282;

    /**
     * The parameter <code>public.getallpropertiesofmarker.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getallpropertiesofmarker.property_id</code>.
     */
    ...
    /**
     * The parameter <code>public.getallpropertiesofmarker.property_name</code>.
     */
    ...
    /**
     * The parameter <code>public.getallpropertiesofmarker.property_value</code>.
     */
    ...
    public Getallpropertiesofmarker() {
        super("getallpropertiesofmarker", Public.PUBLIC);
