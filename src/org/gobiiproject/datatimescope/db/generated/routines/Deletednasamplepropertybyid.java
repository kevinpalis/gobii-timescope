...
public class Deletednasamplepropertybyid extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -90858732;

    /**
     * The parameter <code>public.deletednasamplepropertybyid.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.deletednasamplepropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.deletednasamplepropertybyid.propertyid</code>.
     */
     ...
     */
    public Deletednasamplepropertybyid() {
        super("deletednasamplepropertybyid", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
