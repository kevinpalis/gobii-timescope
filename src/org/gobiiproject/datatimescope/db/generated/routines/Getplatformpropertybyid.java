...
public class Getplatformpropertybyid extends AbstractRoutine<String> {

    private static final long serialVersionUID = 614368122;

    /**
     * The parameter <code>public.getplatformpropertybyid.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.getplatformpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getplatformpropertybyid.propertyid</code>.
     */
     ...
     */
    public Getplatformpropertybyid() {
        super("getplatformpropertybyid", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
