...
public class Upsertmarkerpropertybyid extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1217675469;

    /**
     * The parameter <code>public.upsertmarkerpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.upsertmarkerpropertybyid.propertyid</code>.
     */
    ...
    /**
     * The parameter <code>public.upsertmarkerpropertybyid.propertyvalue</code>.
     */
     ...
     */
    public Upsertmarkerpropertybyid() {
        super("upsertmarkerpropertybyid", Public.PUBLIC);
