...
public class Getdnasamplepropertybyid extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1395805430;

    /**
     * The parameter <code>public.getdnasamplepropertybyid.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.getdnasamplepropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.getdnasamplepropertybyid.propertyid</code>.
     */
     ...
     */
    public Getdnasamplepropertybyid() {
        super("getdnasamplepropertybyid", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
