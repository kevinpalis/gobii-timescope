...
public class Updatednarunpropertybyname extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1630754141;

    /**
     * The parameter <code>public.updatednarunpropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.updatednarunpropertybyname.propertyname</code>.
     */
    ...
    /**
     * The parameter <code>public.updatednarunpropertybyname.propertyvalue</code>.
     */
     ...
     */
    public Updatednarunpropertybyname() {
        super("updatednarunpropertybyname", Public.PUBLIC);
