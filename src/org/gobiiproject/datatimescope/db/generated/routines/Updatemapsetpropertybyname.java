...
public class Updatemapsetpropertybyname extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -458868253;

    /**
     * The parameter <code>public.updatemapsetpropertybyname.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.updatemapsetpropertybyname.propertyname</code>.
     */
    ...
    /**
     * The parameter <code>public.updatemapsetpropertybyname.propertyvalue</code>.
     */
     ...
     */
    public Updatemapsetpropertybyname() {
        super("updatemapsetpropertybyname", Public.PUBLIC);
