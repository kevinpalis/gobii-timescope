...
public class Upsertprotocolpropertybyid extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1613375859;

    /**
     * The parameter <code>public.upsertprotocolpropertybyid.id</code>.
     */
    public static final Parameter<Integer> ID = createParameter("id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.upsertprotocolpropertybyid.propertyid</code>.
     */
    ...
    /**
     * The parameter <code>public.upsertprotocolpropertybyid.propertyvalue</code>.
     */
     ...
     */
    public Upsertprotocolpropertybyid() {
        super("upsertprotocolpropertybyid", Public.PUBLIC);
