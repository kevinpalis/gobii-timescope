...
public class Keys {
    ...
    public static final Identity<GetallcontactsbyroleRecord, Integer> IDENTITY_GETALLCONTACTSBYROLE = Identities0.IDENTITY_GETALLCONTACTSBYROLE;
    public static final Identity<GetexperimentsbyprojectidRecord, Integer> IDENTITY_GETEXPERIMENTSBYPROJECTID = Identities0.IDENTITY_GETEXPERIMENTSBYPROJECTID;
    public static final Identity<GetmanifestbyexperimentidRecord, Integer> IDENTITY_GETMANIFESTBYEXPERIMENTID = Identities0.IDENTITY_GETMANIFESTBYEXPERIMENTID;
    public static final Identity<GetrolesofcontactRecord, Integer> IDENTITY_GETROLESOFCONTACT = Identities0.IDENTITY_GETROLESOFCONTACT;
    ...
    private static class Identities0 extends AbstractKeys {
        ...
        public static Identity<GetallcontactsbyroleRecord, Integer> IDENTITY_GETALLCONTACTSBYROLE = createIdentity(Getallcontactsbyrole.GETALLCONTACTSBYROLE, Getallcontactsbyrole.GETALLCONTACTSBYROLE.CONTACT_ID);
        public static Identity<GetexperimentsbyprojectidRecord, Integer> IDENTITY_GETEXPERIMENTSBYPROJECTID = createIdentity(Getexperimentsbyprojectid.GETEXPERIMENTSBYPROJECTID, Getexperimentsbyprojectid.GETEXPERIMENTSBYPROJECTID.EXPERIMENT_ID);
        public static Identity<GetmanifestbyexperimentidRecord, Integer> IDENTITY_GETMANIFESTBYEXPERIMENTID = createIdentity(Getmanifestbyexperimentid.GETMANIFESTBYEXPERIMENTID, Getmanifestbyexperimentid.GETMANIFESTBYEXPERIMENTID.MANIFEST_ID);
        public static Identity<GetrolesofcontactRecord, Integer> IDENTITY_GETROLESOFCONTACT = createIdentity(Getrolesofcontact.GETROLESOFCONTACT, Getrolesofcontact.GETROLESOFCONTACT.ROLE_ID);
