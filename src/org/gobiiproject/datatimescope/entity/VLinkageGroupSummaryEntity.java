...
public class VLinkageGroupSummaryEntity extends VDatasetSummaryRecord {
	private String piName;
	
	public VLinkageGroupSummaryEntity() {
		new VDatasetSummaryRecord();
	}

	/**
	 * Create a detached, initialised VLinkageGroupSummaryRecord
	 */
	public VLinkageGroupSummaryEntity(Integer linkageGroupId, String linkageGroupName, Integer experimentId, String experimentName, Integer callinganalysisId, String callingnalysisName, Integer[] analyses, String dataTable, String dataFile, String qualityTable, String qualityFile, Object scores, String createdByUsername, Date createdDate, String modifiedByUsername, Date modifiedDate, String statusName, String typeName, String jobName, Integer projectId, String projectName, Integer piId, String piFirstname, String piLastname) {
		new VDatasetSummaryRecord();
     ...
     */
	 ...
	 public String getAllDelimitedBy(String delim){
	    	...
	    	sb.append(Utils.checkInteger((Integer) get(0))+delim); //getLinkageGroupId()
	    	sb.append((Utils.checkString((String)get(1))).toLowerCase()+delim); //getLinkageGroupName()
	 ...
	 public String getHeaderDelimitedBy(String delim){
		 StringBuilder sb = new StringBuilder();
		 sb.append("Linkage Group Id" +delim);
		 sb.append("Linkage Group Name" +delim);
	...
	public Object getLinkageGroupId() {
		// TODO Auto-generated method stub
		return null;
	}
